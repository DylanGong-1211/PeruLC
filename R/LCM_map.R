...
forest_vals   <- c(50, 60, 61, 62, 70, 71, 72, 80, 81, 82, 90)
builtup_vals  <- c(190)
water_vals    <- c(210)
ice_vals      <- c(220)
...
plot(lc2000_peru,
  col = c("grey", "gold", "forestgreen", "red", "blue", "lightcyan", "tan"),
  main = "Peru Land Cover 2000",legend = FALSE, axes = TRUE)
lines(peru, col = "black", lwd = 0.5)
legend(
  "bottomleft",legend = c("Other", "Cropland", "Forest", "Built-up", "Water", "Snow/Ice", "Bare area"),
 fill = c("grey", "gold", "forestgreen", "red", "blue", "lightcyan", "tan"),
  cex = 0.6)
...
legend("bottomleft",
  legend = c("Other", "Cropland", "Forest", "Built-up", "Water", "Snow/Ice", "Bare area"),
  fill = c("grey", "gold", "forestgreen", "red", "blue", "lightcyan", "tan"),
  cex = 0.6)
